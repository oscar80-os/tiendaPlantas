...
async function loadProducts() {
    try {
        // Verificar si db está definido (Firestore)
    ...
    products = [
        {
            ...
            price: 35000,
            category: 'plantas',
            image: 'https://images.unsplash.com/photo-1593691509543-55-32e3e373181?w=400'
        },
        {
            id: '2',
        ...
        },
        {
            ...
            price: 85000,
            category: 'madera',
            image: 'https://images.unsplash.com/photo-1595428774223-ef52b71ac8cf?w=400'
        },
        {
            id: '4',
        ...
        },
        {
            ...
            price: 28000,
            category: 'materas',
            image: 'https://images.unsplash.com/photo-1614597204159-1d9aaf5a9b3c?w=400'
        },
        {
            id: '6',
            ...
            price: 120000,
            category: 'madera',
            image: 'https://images.unsplash.com/photo-1595246140625-573b3c444f8e?w=400'
        }
    ];
    applyFiltersAndSearch();
}
...
function selectPayment(method) {
    ...
    if (instructionText) instructionText.textContent = text.replace(/\*/g, ''); // Eliminar asteriscos para texto plano
    if (instructionsDiv) instructionsDiv.style.display = 'block';
    const confirmBtn = document.getElementById('confirm-payment-btn');
    if (confirmBtn) confirmBtn.style.display = 'block';
}

// Función para confirmar pago y enviar WhatsApp
function confirmPayment() {
    ...
    // Crear mensaje de WhatsApp con el resumen y método de pago
    ...
    message += `\n💳 *Método de pago elegido:* ${getPaymentName(selectedPayment)}\n\n`;
...
// Helper para obtener nombre del método
...
// Función para toggle del menú social
...
// Función para tracking de clics en redes sociales
function trackSocialClick(network) {
    console.log(`🔗 Click en ${network}`);
    
    // Cerrar el menú después del clic (solo si no es WhatsApp)
...
// Cerrar el menú social al hacer clic fuera
document.addEventListener('click', (e) => {
    ...
    // No cerrar si se hace clic en WhatsApp
...
// Cerrar modal de pago al hacer clic fuera del contenido
...
// Prevenir que el menú social se cierre al hacer clic dentro
document.addEventListener('DOMContentLoaded', () => {
